...
def make_str_exp_all(exp_prefix, index_variation):
    default = "java -jar ./jars/experiment02.jar ./Cenarios/Environment01.oomdp ./Cenarios/exp02/{} {} 10000 ./results/exp02.csv {} {}"
    states = []
    ...
    for exp_num in range(1, 101):
        ...
        train_mind = "trainned_minds/complete.trainned.exp02.{}.mind".format(exp_num)
