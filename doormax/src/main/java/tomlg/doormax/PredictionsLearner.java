 ...
 */
	 ...
	 */
	public PredictionsLearner(OOMDP d, List<PropositionalFunction> propFuns, List<EffectType> effectsToUse, List<Action> actionsToUse, OOMDPState initialState, int k, String statePerceptionToUse) {
	...
	private void learnForOClassAndAtt(OOMDPState s, Action a, OOMDPState sPrime, ObjectClass oClass, ObjectAttribute att) {
	...
	private List<Prediction> getAllPredictionsByClassEtc(ObjectClass oClass, ObjectAttribute att, Action ga) {
		List<Prediction> allPredictions = new ArrayList<Prediction>();
		for (E eTypeString : this.effectsToUse) {
